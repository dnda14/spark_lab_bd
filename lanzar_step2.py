...
def enviar_step():
    ...
    script_local = 'spark_indice_df.py'
    script_s3_key = 'scripts/spark_indice_df.py'
    ...
    ruta_entrada = f"s3://{bucket}/input_escala/csv_75/" 
    ruta_salida = f"s3://{bucket}/output/spark_indice_75/"
