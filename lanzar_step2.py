...
def enviar_step():
    ...
    script_local = 'spark_wordcount.py'
    script_s3_key = 'scripts/spark_wordcount.py'
    ...
    ruta_entrada = f"s3://{bucket}/input_escala/csv_25/" 
    ruta_salida = f"s3://{bucket}/output/spark_indice_25/"

    step_config = {
        'Name': 'Spark_WordCount_Step',
